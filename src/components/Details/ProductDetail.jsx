...
const ProductDetail = ({product}) => {
    return (
        <>
            <Typography style={{ fontSize: 28, fontWeight: 600 }}>{product.title.longTitle}</Typography>
            <Typography>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge/> Get extra 15% off (price includes of discount) T&C</Typography>
                <Typography><StyledBadge/> Partner OfferSign up for Flipkart Pay Later and get Flipkart Gift Card worth up to ₹500*Know More</Typography>
